...
const imageRoot = join(projectRoot, 'src', 'assets', 'images');
...
console.log(`- Racine auditée: ${relative(projectRoot, imageRoot).replaceAll('\\', '/')}`);
console.log(`- Total images source: ${summary.total}`);
