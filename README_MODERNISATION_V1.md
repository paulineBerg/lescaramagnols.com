...
Ce perimetre est isole et cartographie dans `docs/README_REFONTE_LOT_C.md`.
Le meme audit confirme aussi qu'un bloc de vrai code produit doit etre consolide a part : `70` fichiers sous `backend/src`, `57` sous `backend/tests`, `12` templates admin, `6` migrations SQL editoriales et `8` outils frontend. Le decoupage recommande par domaines est documente dans `docs/README_CONSOLIDATION_LOT_D.md`.
