...
Reference :
- `docs/archive/audit-nettoyage-priorise-depot-local-2026-04-16.md`
...
### 6. Documentation `docs/archive/blog-plan-v1.md`

Statut :
- abandonne comme document actif

Remplace par :
- `docs/archive/blog-plan-v1.md` pour la trace historique
- `docs/roadmap/README.md` pour la trajectoire de modernisation
- `docs/deployment/README.md` pour l'etat deployable et les gates
