...
12ter. [x] permettre un rattachement par ligne agence a une propriete et a un bien locatif, avec une propriete de document conservee comme fallback et propagee aux lignes sans choix manuel ; les releves ASG exploitent aussi les noms de locataires, les totaux de lot et les bases de charges pour proposer automatiquement le bien locatif quand un bail actif unique correspond ;
