...
- production `caramagnols` : `DEPLOY_TARGET=prod`, ne jamais synchroniser `backend/private/`.
- preproduction `caramagnols-preprod` : `DEPLOY_TARGET=preprod`, synchroniser `backend/private/` uniquement pour tester l'espace prive complet.
- dans les deux cas, `.env`, `backend/config/*.override.php`, secrets, logs, caches et uploads runtime restent propres a l'environnement serveur.
...
- [x] Documentation alignee : `docs/security/README.md`, `docs/backend/public-entrypoints.md`, `README.md`.
...
- [x] Politique de versionning clarifiee dans `frontend/README.md` et `frontend/README.md`.
...
- coherence documentaire :
  ...
  - docs canoniques maj : `README.md`, `docs/deployment/README.md`, `frontend/README.md`, `frontend/README.md`, `docs/backend/logging.md`
- backup/restore :
...
- runbook go-live ajoute : `docs/deployment/runbook-v1-go-live.md` (check-env, check-security-headers, check-log-alerts, check-instagram-feed, rotation secrets).
...
- plan d'execution documente dans `docs/deployment/runbook-v1-go-live.md` (J+1/J+7).
...
- lot 8.3 (legacy/docs) :
  ...
  - verification locale de l'absence de reference active: `rg -n "adminFtyhik5642sZ" README.md docs/README.md docs backend/README*.md backend/core backend/src backend/public frontend` -> aucun resultat.
  - perimetre de refonte heritage identifie par l'audit hygiene du `2026-04-16` documente dans `docs/refonte-lot-c.md` : suppressions suivies `pages/site`, `adminFtyhik5642sZ`, `installsql.php`, `menu_data.php`, `sitemap.php` a livrer a part du nettoyage courant.
  - perimetre de nouveau code produit identifie par ce meme audit documente dans `docs/consolidation-lot-d.md` : consolidation par domaines `socle HTTP`, `admin/navigation`, `blog/sql`, `logging`, `outillage frontend`.
...
- coherence documentaire :
  ...
  - README de construction V1 renommes avec suffixe `_V1` :
    ...
    - `docs/archive/audit-complet-v1.md`
    - `docs/archive/audit-plan-action-v1.md`
    - `docs/roadmap/README.md`
    - `docs/archive/blog-plan-v1.md` (archive)
    - `frontend/README.md`
