...
- l'installation est maintenant documentee hors HTTP dans `docs/backend/installation-hors-webroot.md`
...
Le document `frontend/README.md` couvre deja ce sujet en detail.
