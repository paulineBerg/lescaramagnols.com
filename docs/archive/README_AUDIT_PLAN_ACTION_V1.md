...
- P0.1 : installateurs publics retires du webroot et remplaces par `backend/README_INSTALLATION_HORS_WEBROOT.md`
...
- P1.3 : RSS et admin convergent vers `backend/public/index.php` avec gouvernance commune documentee dans `backend/README_PUBLIC_ENTRYPOINTS.md`
