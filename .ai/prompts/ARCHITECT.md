...
le présent `ARCHITECT.md` comme prompt à exécuter et si `CURRENT_TASK.md` fait
concorder la phase d'architecture, ce prompt, son identifiant local, le passage
de relais requis et le périmètre de lecture. Une mention narrative ou une simple
demande de lecture ne vaut pas activation. En cas d'absence ou de contradiction,
rester en lecture seule, signaler le blocage et s'arrêter.
