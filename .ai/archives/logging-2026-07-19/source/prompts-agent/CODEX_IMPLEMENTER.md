...
`Résultat Codex ou Mistral`, `Tests et validations` et `État` sans effacer les
sections precedentes.

Aucun commit, push, deploiement, acces production, migration ou transfert de
donnees sans autorisation explicite. N'affiche et ne versionne aucun secret.
