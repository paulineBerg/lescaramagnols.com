...
- [ ] Documenter les nouvelles routes dans `backend/README_PUBLIC_ENTRYPOINTS.md` si exposition HTTP modifiee.
...
- [ ] Documenter la verification dans `README_SECURITE_ADMIN_V1.md` et ce backlog.
...
- [ ] Mettre a jour `backend/README_INSTALLATION_HORS_WEBROOT.md` si la procedure evolue.
...
1. `README_PRIVATE_FAMILLE_V1.md`
2. `README.md`
