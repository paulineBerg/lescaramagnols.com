...
- dans le cadre du Lot D, les scripts `frontend/tools/*` restent a consolider avec cette politique artefacts, pas dans un commit melange avec le backend editorial
