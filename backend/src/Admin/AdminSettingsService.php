...
final class AdminSettingsService
{
    ...
    private function privateMailTemplateCatalog(): array
    {
        ...
        $definitions = [
            ...
            ['discussion_message_subject', 'Sujet notification discussion', 'discussion_message_body', 'Message notification discussion', ['email', 'today', 'conversation_url', 'login_url', 'private_url', 'reply_to', 'site_name']],
