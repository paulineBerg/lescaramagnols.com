...
$privateDiscussionMaxUserStorageBytes = max(0, (int) env('PRIVATE_DISCUSSION_MAX_USER_STORAGE_BYTES', 256 * 1024 * 1024));
$privateDiscussionMaxConversationStorageBytes = max(0, (int) env('PRIVATE_DISCUSSION_MAX_CONVERSATION_STORAGE_BYTES', 512 * 1024 * 1024));
...
$appConfig = [
    ...
    'private' => [
        ...
        'discussions' => [
            ...
            'max_user_storage_bytes' => $privateDiscussionMaxUserStorageBytes,
            'max_conversation_storage_bytes' => $privateDiscussionMaxConversationStorageBytes,
