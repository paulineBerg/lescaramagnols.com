...
while IFS= read -r rel_path; do
  ...
  case "$path" in
    .env|.env.*|config/*.override.php|vendor/*|node_modules/*|tests/*|docs/*|README*|var/*|phpunit.xml|phpstan.neon*|phpcs.xml|data/snapshots/*|data/logs/*|public/assets/images/*|public/uploads/*)
      continue
      ;;
  esac
