...
<p class="muted">
  <?php echo htmlspecialchars(
      $translate(
          'TXT_PRIVATE_PASSWORD_FORGOT_INTRO',
          'Indiquez votre adresse email. Si un compte existe, vous recevrez un lien pour créer un nouveau mot de passe.'
      ),
      ENT_QUOTES,
      'UTF-8'
  ); ?>
...
<form method="post" action="<?php echo htmlspecialchars(private_portal_url('password_forgot'), ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <div class="private-actions">
    <button type="submit"><?php echo htmlspecialchars($translate('TXT_PRIVATE_PASSWORD_FORGOT_SUBMIT', 'Recevoir le lien sécurisé'), ENT_QUOTES, 'UTF-8'); ?></button>
  </div>
</form>
