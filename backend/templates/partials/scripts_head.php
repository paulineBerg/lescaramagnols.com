...
?>
  ...
  <style<?php echo $cspNonce !== '' ? ' nonce="' . htmlspecialchars($cspNonce, ENT_QUOTES, 'UTF-8') . '"' : ''; ?>>
    ...
    .site-nav-panel{position:absolute;top:100%;left:0;z-index:35;min-width:11rem;padding:.35rem;border-radius:.7rem;background:rgba(14,30,61,.96);box-shadow:0 1.2rem 2.1rem rgba(0,0,0,.24)}
