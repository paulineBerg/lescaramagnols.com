...
$blocks['EditRegion2'] = '
    <div id="blocHaut" class="border">' . t("TXT_HISTOIREARONDE9INTRO") . '</div>
';
    ...
    <div id="menurectanglewindows">
        <div id="boutonrectanglerouge">
            <a href="../simca/la-simca-aronde-1300-voiture-de-collection.php">
                ' . t("MENU_UI_HISTOIREARONDE1300") . '
                <img src="/assets/images/structure/menu/auto-retro/uisimca.jpg"
                     alt="' . t("MENU_UI_HISTOIREARONDE1300") . '"
                     title="' . t("MENU_UI_HISTOIREARONDE1300") . '">
            </a>
        </div>
    </div>
    <div id="menurectanglewindows">
